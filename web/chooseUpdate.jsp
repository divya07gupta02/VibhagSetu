...
<title>Vibhag Setu - Update Records</title>
...
Choose the record you want to modify
</p>
...
<i class="fas fa-user-edit text-[#0b6b53] text-3xl"></i>
</div>
...
Modify faculty member records in the system.
</p>
...
<div class="bg-[#e6f2ee] w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
<i class="fas fa-user-pen text-[#0b6b53] text-3xl"></i>
</div>
...
<p class="text-gray-500 text-sm">
Modify class representative records.
</p>
