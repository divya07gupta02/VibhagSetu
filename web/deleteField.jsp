...
<title>Delete Faculty | Vibhag Setu</title>
...
<form method="get" action="deleteField.jsp">

<div class="search-box">

<input type="text" name="fid" placeholder="Search by Faculty ID" class="search-input">

<input type="text" name="name" placeholder="Search by Faculty Name" class="search-input">
...
<button type="button"
class="delete-btn"
onclick="openDeleteModal(<%=rs.getInt("F_ID")%>)">
Delete
</button>
...
document.getElementById("deleteId").value=deleteFacultyId;
