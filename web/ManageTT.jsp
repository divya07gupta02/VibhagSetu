...
<html>
<head>
<title>Manage Timetable | Vibhag Setu</title>
...
<a href="<%= (search != null && !search.trim().equals("")) ? "ManageTT.jsp" : "adminDash.jsp" %>" class="back-btn">
...
Select a department to manage faculty timetable
</p>
...
<a href="ShowFaculty.jsp?did=<%=rs.getInt("D_ID")%>"
