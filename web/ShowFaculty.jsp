...
<html>
<head>
<title>Show Faculty | Vibhag Setu</title>
...
Select faculty to upload timetable
</p>
...
<form method="get"
class="flex gap-4 mb-12 max-w-3xl mx-auto">
...
<div class="bg-white rounded-3xl shadow-md overflow-hidden max-w-4xl mx-auto">
...
<th class="px-6 py-4 text-center">Upload Timetable</th>
...
<a href="UploadTT.jsp?fid=<%=rs.getInt("F_ID")%>&did=<%=did%>"
